...
class ScheduleWeekContent extends React.Component{
    ...
    fillWorkoutContent(index){
        ...
        if(index === 0){
            ...
            var thrDiv = <div className="ScheduleWeek-THR" ><p className="ScheduleWeek-THR-Content" id="thrTitle">{"Target Heart Rate"}</p></div>;
    ...
    render(){
        ...
        var backColor = (this.props.index === 0 ? "#b98800" : (this.props.count % 2 === 0 ? "#d49c00" : " #ffbb00"));

        return(

                <div className="ScheduleWeek-Row-Content-Wrapper" style={{height: h, background: backColor}}>
                    {this.fillWorkoutContent(this.props.index)}
                </div>                 
